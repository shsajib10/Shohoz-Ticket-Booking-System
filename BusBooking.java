...
public class BusBooking extends JFrame implements ActionListener {
        ...
        bookButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (fromIndex == toIndex) {
                    JOptionPane.showMessageDialog(BusBooking.this, "Please select different cities for From and To.",
                ...
                try {
                    ...
                    if (quantity <= 0) {
                        JOptionPane.showMessageDialog(BusBooking.this, "Number of tickets must be greater than zero.",
                                "Input Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    ...
                    JOptionPane.showMessageDialog(BusBooking.this, "Please enter a valid number of tickets.",
                            "Input Error", JOptionPane.ERROR_MESSAGE);
                }
            }
