...
public class TrainBooking extends JFrame implements ActionListener {
    ...
    private final String[] cities = {"Dhaka", "Chittagong", "Sylhet", "Rajshahi", "Khulna"};
    ...
    public TrainBooking() {
        super("Railway Ticket Booking System");
        setSize(850, 650);
        this.setLocationRelativeTo(null);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        textareaclr=new Color(244, 231, 225);
        lblbg=new Color(1, 85, 81);
        ...
        acButton.setBounds(370, 270, 80, 30);
        panel.add(acButton);

        nonAcButton = new JRadioButton("Non-AC", true);
        ...
        bookButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (fromIndex == toIndex) {
                    JOptionPane.showMessageDialog(TrainBooking.this, "Please select different cities for From and To.", "Input Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                try {
                    ...
                    if (quantity <= 0) {
                        JOptionPane.showMessageDialog(TrainBooking.this, "Number of tickets must be greater than zero.", "Input Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    ...
                    JOptionPane.showMessageDialog(TrainBooking.this, "Please enter a valid number of tickets.", "Input Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        deleteButton.setBackground(brgred);
